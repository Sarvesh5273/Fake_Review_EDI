      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            VertexShield provides enterprise-grade threat intelligence to detect, prove, and neutralize coordinated bot networks and automate platform disputes.
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">Protect Enterprise Revenue</span>
