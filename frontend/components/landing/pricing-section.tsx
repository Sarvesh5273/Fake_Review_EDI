...
const plans = [
  ...
  },
  {
    ...
    description: "For mid-market e-commerce operations",
    price: { monthly: 499, annual: 499 },
    features: [
      "Up to 5,000 SKUs",
      "Real-time GhostWire defense",
      "Automated dispute exports",
    ],
    cta: "Sign In",
    highlight: true,
  },
  {
    name: "Global Retail",
    description: "For enterprise retail operations",
    price: { monthly: null, annual: null },
    features: [
      "Unlimited SKUs",
      "Bipartite Graph API access",
