...
import { ShoppingCart, Store, Globe, Star } from "lucide-react";

const logos: Record<string, React.ReactNode> = {
  "Amazon Seller Central": <ShoppingCart className="w-6 h-6" />,
  "Shopify Plus": <Store className="w-6 h-6" />,
  "Walmart Marketplace": <Globe className="w-6 h-6" />,
  "Trustpilot": <Star className="w-6 h-6" />,
};
