...
const steps = [
  {
    ...
    description: "API integration with marketplaces to sync SKUs, storefronts, and review sources.",
    code: `await vertexShield.connect({
  ...
  },
  {
    ...
    description: "GhostWire middleware detects temporal bursts and semantic duplication in real time.",
    code: `ghostWire.monitor({
  signals: ['burst', 'duplication'],
  cadence: 'real-time',
  riskModel: 'bipartite'
})`,
  },
  {
    ...
    title: "Neutralize",
    subtitle: "the threat",
    description: "Export dispute proof or automatically flag via API to remove coordinated attacks.",
    code: `disputes.export({
  destination: 'amazon-seller-central',
  format: 'csv',
  autoFlag: true
})`,
  },
